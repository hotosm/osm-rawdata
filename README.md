...
query. The YAML format was originalkly used by Export Tool, but later
...
also generating that query from the config file.

# The files

## geofabrik.py

This is a simple utility to download file from GeoGFabrik.
